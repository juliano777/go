...
**Declaração ou atribuição de valores (permitido ou não)**

| Ação | Nível de pacote (fora de funções) | Dentro de funções (`main`, etc.) |
| :--- | :--- | :--- |
| **Declaração completa** (`var array [5]int`) | **Sim** | **Sim** |
| **Declaração curta** (`array := ...`) | **Não** | **Sim** |
| **Atribuição simples** (`array[0] = 73`) | **Não** | **Sim** |
